...
//when button presed a it will start autoplay
...
function conformation(){
  document.querySelector('.js-confirmation-dialog').innerHTML = 'Are you sure you want to reset the score <button class="js-yes-button yes-button">yes</button><button class="js-no-button no-button">no</button>'

  document.querySelector('.js-yes-button').addEventListener('click',()=>{
    resetPlay();
    document.querySelector('.js-confirmation-dialog').innerHTML ='';
  });
